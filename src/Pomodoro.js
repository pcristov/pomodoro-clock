	...
	render() {
		return (
			<div className="container" id="container">
				...
				<div className="time-left" id="time-left" dangerouslySetInnerHTML={{__html: (this.state.minutes < 10 ? `0${ this.state.minutes }` : this.state.minutes) + ':' + (this.state.seconds < 10 ? `0${ this.state.seconds }` : this.state.seconds) }}></div>
